...
public class GalleryManager : MonoBehaviour {
    ...
    void Awake() {
        ...
        iconSet = new() {
            { 0, new(galleryImages[0], "Mars", "[COLD, DRY, VACCUM] Despite being our closet neighbour, the red planet is vastly different to earth.", false) },
            { 1, new(galleryImages[1], "Frosted Chasm", "[COLD, DRY, IDEAL] A planet with jagged, ice-capped monuntains broken up by FROST [-1, 0, 0] chutes.", false) },
            { 2, new(galleryImages[2], "Saturn", "[COLD, DRY, GASEOUS] A might gas giant, Saturn is also known for its majestic rings of ice and rock.", false) },
            { 3, new(galleryImages[3], "Ice Cube", "[COLD, HUMID, VACCUM] With no atmosphere or heat, this planet has been encased in a block of ice.", false) },
            { 4, new(galleryImages[4], "Earth (Frozen)", "[COLD, HUMID, IDEAL] A planet not too dissimlar to our own, the low temperatures have covered this familar planet in sheets of ice.", false) },
            ...
            { 6, new(galleryImages[6], "Haunted Planet", "[COLD, WET, VACCUM] With no atmosphere, this chilly wet planet only moves beneath the surface, given the illusion of a spirit trapped within.", false) },
            ...
            { 9, new(galleryImages[9], "Mercury", "[TEMPERATE, DRY, VACCUM] Due to a fascinating combination of its thin atmosphere and its closeness to the sun, Mercury has a wide temperature range. ", false) },
            { 10, new(galleryImages[10], "Earth (Barren)", "[TEMPERATE, DRY, IDEAL] A planet not too dissimlar to our own, the lack of water made it impossible for life to take form here.", false) },
            ...
            { 12, new(galleryImages[12], "Earth (Dull)", "[TEMPERATE, HUMID, VACCUM] A planet not too dissimilar to our own, the absence of oxygen made it impossible for life to form here.", false) },
            ...
            { 15, new(galleryImages[15], "Serious", "[TEMPERATE, WET, VACCUM] A very serious planet that definitely isn't pandering to any Game Jam hosts or anything like that. Can push other planets with its very serious hat.", false) },
            ...
            { 18, new(galleryImages[18], "Sand", "[HOT, DRY, VACCUM] A sparse planet full of dunes and not much between them. The intense heat and lack of atmosphere make it especially hostile to most.", false) },
            ...
            { 20, new(galleryImages[20], "Venus", "[HOT, DRY, GASEOUS] The other neighbour to our own planet, Venus is quite differnt to Mars, with a dense, hot atmosphere.", false) },
            { 21, new(galleryImages[21], "Radioactive", "[HOT, HUMID, VACCUM] Intense levels of heat unbound by the atmosphere have caused this planet to become strongly iradiated. don't stay for too long!", false) },
            ...
            { 24, new(galleryImages[24], "Glass", "[HOT, WET, VACCUM] A unique combination of heat and pressure have resulted in an entire planet of glass! If this planet is heated further, it propgates HEAT [+1, -1, 0] forward itself.", false) },
            ...
            { 28, new(galleryImages[28], "Sun", "The big, bright heart of our solar system, the Sun provides orbital stability and SOLAR HEAR [+1, 0, 0] to all that surround it.", true) },
        };
    }
