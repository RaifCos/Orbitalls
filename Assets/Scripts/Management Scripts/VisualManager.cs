...
public class VisualManager : MonoBehaviour {
    ...
    private readonly string[] levelStrings = {
        "greetings explorer, welcome to space! select a planet using your MOUSE and spin it with the A/S keys. If the planet lies on an orbatal line, you can move it around using W/D. You can also use your arrow keys.",
        ...
        "the glass planet concentrates any heat it receives and pushes it out forward, increasing your planatery reach.",
        "remember, we can block the head produced by the sun using by other planets.",
        ...
        "another new discovery! it appears this planet has a gravatational pull so strong, it can yank other planets like it's nothing!",
        ...
        "...this is a scary thought to have, just how cold and indiffernt the universe is. You nearly start to wonder- are we the only ones here?",
        "However, there is a certain beauty to the way the universe works, and we can see it in little palce we like to call... home!",
